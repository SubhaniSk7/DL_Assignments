...
class listDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.train:
            ...
            img = Image.open('C:\\Users\\Subhani\\PycharmProjects\\DL_Assignments\\Assignment_1\\pytorch-0.4-yolov3-master\\data\\coco'+imgpath).convert('RGB')
            if self.shape:
            ...
            try:
                tmp = torch.from_numpy(read_truths_args('C:\\Users\\Subhani\\PycharmProjects\\DL_Assignments\\Assignment_1\\pytorch-0.4-yolov3-master\\data\\coco'+labpath, 8.0/img.width).astype('float32'))
            except Exception:
                tmp = torch.zeros(1,5)
