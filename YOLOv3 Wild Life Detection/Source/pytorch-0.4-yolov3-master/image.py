...
def load_data_detection(imgpath, shape, crop, jitter, hue, saturation, exposure):
    ...
    label = fill_truth_detection('C:\\Users\\Subhani\\PycharmProjects\\DL_Assignments\\Assignment_1\\pytorch-0.4-yolov3-master\\data\\coco'+labpath, crop, flip, -dx, -dy, sx, sy)
    return img, label
